...
from formation_indus_ds_avancee.train_and_predict import *
...
def predict_endpoint():
    ...
    {"Wind_turbine_name": "R80721", "Date_time": "2017-02-08T08:00:00+01:00", "Ba_avg": 44.99, "Ba_min": 44.99,
     ...
     "Git_max": 35.70, "Git_std": 10, "Gost_avg": 39.58, "Gost_min": 39.04, "Gost_max": 40.20, "Gost_std": 0.4,
    ...
    # Prepare data.
    preprocessed_received_data_df = prepare_features(received_data_df, False)

    # Load model.
    model_path = "/home/jovyan/work/Formation-MLOps-2/exposition/model_as_a_service/20200616-140746.joblib"
    prediction = predict(preprocessed_received_data_df, model_path)
